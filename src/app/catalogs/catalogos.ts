export const ANIOS: any = [
  ...
  export const PORCENTAJES_OC_SP: any = [
    ...
    {id: 8, descripcion: "65"},
    {id: 9, descripcion: "60"},
    {id: 10, descripcion: "55"},
    {id: 11, descripcion: "50"},
    {id: 12, descripcion: "45"},
    {id: 13, descripcion: "40"},
    {id: 14, descripcion: "35"},
    {id: 15, descripcion: "30"},
    {id: 16, descripcion: "25"},
    {id: 17, descripcion: "20"},
    {id: 18, descripcion: "15"},
    {id: 19, descripcion: "10"},
    {id: 20, descripcion: "5"},
    {id: 21, descripcion: "0"},
  ];
